...
**Training config**: flowBDT with `max_depth=4`, `n_estimators=100`, `n_timesteps=30`, `duplicate_K=20`, DOPRI5 solver (30 steps). Trained on 177,945 top-quark jets. Generated 50,000 jets. **Labels d_2 / d_{23}**: matches paper Table 1 — `d_{23}` is the splitting scale (column 1 of t_hlv12.npy, stored under key "d2" in the preprocessing script due to a labelling bug), `d_2` is the D_2 observable (column 11, stored under key "d2_obs"). All values are from the v3 reanalysis (`rebuttal/results/jetnet_v3/results.json`).

Separation power (triangular discriminator, x100, closer to 0 = better):

| Feature | flowBDT | Truth baseline |
|---------|---------|----------------|
| pT | 0.164 +/- 0.012 | 0.027 +/- 0.005 |
| mass | 0.292 +/- 0.017 | 0.029 +/- 0.005 |
| tau1 | 0.301 +/- 0.017 | 0.028 +/- 0.005 |
| tau2 | 0.737 +/- 0.024 | 0.026 +/- 0.005 |
| tau3 | 0.283 +/- 0.017 | 0.026 +/- 0.005 |
| tau21 | 0.303 +/- 0.016 | 0.027 +/- 0.005 |
| tau32 | 0.245 +/- 0.014 | 0.027 +/- 0.006 |
| d12 | 0.147 +/- 0.013 | 0.028 +/- 0.006 |
| d23 | 0.571 +/- 0.022 | 0.026 +/- 0.005 |
| ecf2 | 0.510 +/- 0.022 | 0.027 +/- 0.005 |
| ecf3 | 1.269 +/- 0.033 | 0.025 +/- 0.005 |
| d2 | 0.269 +/- 0.015 | 0.028 +/- 0.006 |

Wasserstein-1 distance (x10, lower = better):

| Feature | flowBDT | Truth baseline |
|---------|---------|----------------|
| pT | 0.0166 +/- 0.0012 | 0.0037 +/- 0.0016 |
| mass | 0.0136 +/- 0.0006 | 0.0018 +/- 0.0007 |
| tau1 | 0.0200 +/- 0.0007 | 0.0026 +/- 0.0009 |
| tau2 | 0.0218 +/- 0.0005 | 0.0018 +/- 0.0008 |
| tau3 | 0.0057 +/- 0.0002 | 0.0007 +/- 0.0002 |
| tau21 | 0.0671 +/- 0.0029 | 0.0106 +/- 0.0046 |
| tau32 | 0.0819 +/- 0.0051 | 0.0137 +/- 0.0056 |
| d12 | 0.0066 +/- 0.0008 | 0.0022 +/- 0.0007 |
| d23 | 0.0113 +/- 0.0004 | 0.0012 +/- 0.0005 |
| ecf2 | 0.0133 +/- 0.0004 | 0.0012 +/- 0.0005 |
| ecf3 | 0.0004 +/- 0.0000 | 0.0000 +/- 0.0000 |
| d2 | 0.0109 +/- 0.0005 | 0.0017 +/- 0.0007 |
